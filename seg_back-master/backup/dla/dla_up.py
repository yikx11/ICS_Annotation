...
class DLASeg(nn.Module):
    def __init__(self, base_name, classes,
                 pretrained=False, down_ratio=2):
        super(DLASeg, self).__init__()
        assert down_ratio in [2, 4, 8, 16]
        self.first_level = int(np.log2(down_ratio))
        self.base = get_base(base_name, pretrained)
...
def dlasegnet(encoder='dla34', classes=2, pretrained=True, down_ratio=2):
    # 'dla34', 'dla60', 'dla102', 'dla169'
    return DLASeg(encoder, classes, pretrained, down_ratio)
